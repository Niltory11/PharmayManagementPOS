...
public class ViewUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Role", "Date of birth ", "Mobile Number", "Username", "Password", "Address", "Name"
            }
        ));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try {
            ...
            while (rt.next()) {
                model.addRow(new Object[] { rt.getString("appuser_pk"), rt.getString("userRole"), rt.getString("dob"), rt.getString("mobileNumber"), rt.getString("username"), rt.getString("password"), rt.getString("address"), rt.getString("name")});
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
       ...
       int index = jTable2.getSelectedRow(); // Get the selected row index
    TableModel model = jTable2.getModel();
    
    // Retrieve the necessary values from the table
    String userId = model.getValueAt(index, 0).toString(); // Assuming column 0 is `appuser_pk`
    String selectedUsername = model.getValueAt(index, 7).toString(); // Assuming column 7 is `username`

    // Prevent self-deletion or deletion of restricted accounts
    if (username.equals(selectedUsername) || "Ahsan".equals(selectedUsername)) {
        JOptionPane.showMessageDialog(null, "You can't delete your own account or restricted users.");
        return;
    }

    // Confirmation dialog
    int confirm = JOptionPane.showConfirmDialog(null, "Do you want to delete this user?", "Confirm Deletion", JOptionPane.YES_NO_OPTION);
    if (confirm == JOptionPane.YES_OPTION) {
        try {
            // Establish database connection
            Connection con = ConnectionProvider.getCon();

            // Prepare SQL query to delete the user based on their primary key
            String sql = "DELETE FROM appuser WHERE appuser_pk = ?";
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1, userId); // Use the primary key to ensure accurate deletion
            ...
            if (deletedRows > 0) {
                ...
                JOptionPane.showMessageDialog(null, "Unable to delete this user. User not found.");
            }
